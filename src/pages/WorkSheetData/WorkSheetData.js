                ...
                <table className="table worksheetTable">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="valueArea maxTD">
                        <Form.Group
                          ...
                          className="form-group"
                        >
                          <Form.Control value={"0011-18 Al Quote"} />
                        </Form.Group>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="labelArea maxTD">
                        <Form.Group controlId="companyCode" className="form-group">
                          <Form.Control value={"Stephen.Pegrum@emeraldautomotive.com"} />
                        </Form.Group>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="valueArea maxTD">
                        <Form.Group
                          ...
                          className="form-group priceInput"
                        >
                          <Form.Control value={"13.4414811140864"} />
                        </Form.Group>
                      </td>
